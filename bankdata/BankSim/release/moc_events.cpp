...
QT_MOC_LITERAL(1, 7, 12), // "signalLogout"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 16), // "signalReturnMenu"
QT_MOC_LITERAL(4, 38, 23), // "on_buttonLogout_clicked"
QT_MOC_LITERAL(5, 62, 27) // "on_buttonReturnMenu_clicked"

    },
    "Events\0signalLogout\0\0signalReturnMenu\0"
...
void Events::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Events::signalLogout)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Events::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Events::signalReturnMenu)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Events::signalLogout()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Events::signalReturnMenu()
{
