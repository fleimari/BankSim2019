...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DoubleDelegate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DoubleDelegate_t qt_meta_stringdata_DoubleDelegate = {
    {
QT_MOC_LITERAL(0, 0, 14) // "DoubleDelegate"
...
QT_INIT_METAOBJECT const QMetaObject DoubleDelegate::staticMetaObject = { {
    &QStyledItemDelegate::staticMetaObject,
    qt_meta_stringdata_DoubleDelegate.data,
    qt_meta_data_DoubleDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DoubleDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DoubleDelegate.stringdata0))
