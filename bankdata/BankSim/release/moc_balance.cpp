...
QT_MOC_LITERAL(5, 63, 27) // "on_buttonReturnMenu_clicked"
    ...
    "Balance\0signalLogout\0\0signalReturnMenu\0"
...
void Balance::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Balance::signalLogout)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Balance::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Balance::signalReturnMenu)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Balance::signalLogout()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Balance::signalReturnMenu()
{
